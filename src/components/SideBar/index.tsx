...
export const SideBar = ({
  ...
  return (
    <Fragment>
      {expanded && type === 'persistent' && <div className='click-listener' onClick={() => sideBarControl()}></div>}
      <Drawer
        variant={type}
        anchor='left'
        open={expanded}
      ...
      >
        <div className='side-bar-header'>
          <img src={expanded ? logo : icon} alt='Logo' className='logo' onClick={homeNavigate} />
        </div>
